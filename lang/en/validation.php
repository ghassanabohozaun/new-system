...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'servicesItems.*.service_name_ar' => ['required' => 'Arabic service name at row :position is required'],
        'servicesItems.*.service_name_en' => ['required' => 'English service name at row :position is required'],
        'pricesItems.*.price_text_ar' => ['required' => 'Arabic price text at row :position is required'],
        'pricesItems.*.price_text_en' => ['required' => 'English price text at row :position is required'],
        'pricesItems.*.price' => ['required' => 'Price at row :position is required'],
        'notesItems.*.note_text_ar' => ['required' => 'Arabic note at row :position is required'],
        'notesItems.*.note_text_en' => ['required' => 'English note at row :position is required'],
        'offerIncludingItems.*.including_text_ar' => ['required' => 'Arabic "including" text at row :position is required'],
        'offerIncludingItems.*.including_text_en' => ['required' => 'English "including" text at row :position is required'],
        'offerNotIncludingItems.*.not_including_text_ar' => ['required' => 'Arabic "not including" text at row :position is required'],
        'offerNotIncludingItems.*.not_including_text_en' => ['required' => 'English "not including" text at row :position is required'],
    ],
