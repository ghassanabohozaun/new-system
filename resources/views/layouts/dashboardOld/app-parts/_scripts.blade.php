    ...
    {{-- <script src="{!! asset('assets/dashboard') !!}/js/scripts/sweetalert2@11.js" type="text/javascript"></script> --}}

    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{!! asset(path: 'assets/dashboard') !!}/js/scripts/extensions/sweet-alerts.js" type="text/javascript"></script>
    <script src="{!! asset(path: 'assets/dashboard') !!}/js/scripts/my-scripts.js" type="text/javascript"></script>
