...
@section('content')
    <div class="app-content content">
        ...
        <form class="form" action="" method="post" enctype="multipart/form-data" id="updateReservationsFrom">
            @csrf
            @method('PUT')
                            ...
                            <div class="breadcrumb-wrapper col-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">
                                        <a href="#">
                                            {!! __('reservations.update_reservation') !!}
                                        </a>
                                    </li>
                                </ol>
                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" id="reservationID" name="id"
                                                            value="{!! $reservation->id !!}" class="form-control">
                                                    </div>
                                                </div>
                                                <!-- end: input -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="service" name="service" class="form-control">
                                                            ...
                                                            <option value="flight"
                                                                {{ old('service', $reservation->service) == 'flight' ? 'selected' : '' }}>
                                                                {!! __('reservations.flight') !!}
                                                            </option>

                                                            <option value="tour"
                                                                {{ old('service', $reservation->service) == 'tour' ? 'selected' : '' }}>
                                                                {!! __('reservations.tour') !!}
                                                            </option>

                                                            <option value="ticket"
                                                                {{ old('service', $reservation->service) == 'ticket' ? 'selected' : '' }}>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="client_name" name="client_name"
                                                            value="{!! old('client_name', $reservation->client_name) !!}" class="form-control"
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label
                                                            for="client_passport_number">{!! __('reservations.client_passport_number') !!}</label>
                                                        <input type="text" id="client_passport_number"
                                                            value="{!! old('client_passport_number', $reservation->client_passport_number) !!}" name="client_passport_number"
                                                            class="form-control" autocomplete="off"
                                                            placeholder="{!! __('reservations.enter_client_passport_number') !!}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="client_mobile" name="client_mobile"
                                                            value="{!! old('client_mobile', $reservation->client_mobile) !!}" class="form-control"
                                                            autocomplete="off" placeholder="{!! __('reservations.enter_client_mobile') !!}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="client_email" name="client_email"
                                                            value="{!! old('client_email', $reservation->client_email) !!}" class="form-control"
                                                            autocomplete="off" placeholder="{!! __('reservations.enter_client_email') !!}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="number_of_adult" name="number_of_adult"
                                                            value="{!! old('number_of_adult', $reservation->number_of_adult) !!}" class="form-control"
                                                            autocomplete="off" placeholder="{!! __('reservations.enter_number_of_adult') !!}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="number_of_children"
                                                            value="{!! old('number_of_children', $reservation->number_of_children) !!}" name="number_of_children"
                                                            class="form-control" autocomplete="off"
                                                            placeholder="{!! __('reservations.enter_number_of_children') !!}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" id="number_of_babies"
                                                            value="{!! old('number_of_babies', $reservation->number_of_babies) !!}" name="number_of_babies"
                                                            class="form-control" autocomplete="off"
                                                            placeholder="{!! __('reservations.enter_number_of_babies') !!}">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="nationality" name="nationality"
                                                            value="{!! old('nationality', $reservation->nationality) !!}" class="form-control"
                                                            autocomplete="off" placeholder="{!! __('reservations.enter_nationality') !!}">
                                                        ...
                                                        <select class="depature_country_id_select form-control"
                                                            ...
                                                            @foreach ($countries as $country)
                                                                <option value="{{ $country->id }}"
                                                                    {{ old('depature_country_id', $reservation->depature_country_id) == $country->id ? 'selected' : '' }}>
                                                                    {{ $country->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" id="depature_date" name="depature_date"
                                                            value="{!! old('depature_date', $reservation->depature_date) !!}" class="form-control"
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" id="return_date" name="return_date"
                                                            value="{!! old('return_date', $reservation->return_date) !!}" class="form-control"
                                                        ...
                                                        <select id="ticket_id" name="ticket_id" class="form-control">
                                                            ...
                                                            @foreach ($tickets as $key => $ticket)
                                                                <option value="{!! $ticket->id !!}"
                                                                    {{ old('ticket_id', $reservation->ticket_id) == $ticket->id ? 'selected' : '' }}>
                                                                    {!! $ticket->title !!}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="economy_class_name"
                                                            value="{!! old('economy_class_name', $reservation->economy_class_name) !!}" name="economy_class_name"
                                                            class="form-control" autocomplete="off"
                                                            placeholder="{!! __('reservations.enter_economy_class_name') !!}">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select id="economy_class_type" name="economy_class_type"
                                                            ...
                                                            <option value="transit"
                                                                {{ old('economy_class_type', $reservation->economy_class_type) == 'transit' ? 'selected' : '' }}>
                                                                {!! __('reservations.transit') !!}
                                                            </option>

                                                            <option value="direct_flight"
                                                                {{ old('economy_class_type', $reservation->economy_class_type) == 'direct_flight' ? 'selected' : '' }}>
                                                                {!! __('reservations.direct_flight') !!}
                                                            </option>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="notes" name="notes" rows="6" class="form-control" autocomplete="off"
                                                            placeholder="{!! __('reservations.enter_notes') !!}">{!! old('notes', $reservation->notes) !!}</textarea>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        function resetUpdateReservationFrom() {
        ...
        // store
        $("#updateReservationsFrom").on('submit', function(e) {

            e.preventDefault();
            resetUpdateReservationFrom()
            var id = $('#reservationID').val();
            var data = new FormData(this);
            var type = $(this).attr('method');
            var url = "{!! route('dashboard.reservations.update', ':id') !!}".replace(':id', id);
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == true) {
                        console.log(data);
                        // $('#updateReservationsFrom')[0].reset();
