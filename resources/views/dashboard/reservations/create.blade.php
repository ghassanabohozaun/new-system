        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="home-tab">
                    ...
                    <div class="d-md-flex align-items-center justify-content-between border-bottom mb-4 pb-3">
                        <nav aria-label="breadcrumb" class="mb-3 mb-md-0">
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{!! __('reservations.create_new_reservation') !!}</li>
                            </ol>
                        </nav>
                    ...
                    <!-- Main Form Card -->
                    <form action="{{ route('dashboard.reservations.store') }}" method="POST" id="create_reservation_form">
                        @csrf
                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-premium">
                                                        ...
                                                        <input type="text" id="nationality" name="nationality"
                                                            class="form-control" placeholder="{!! __('reservations.nationality') !!}">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-premium">
                                                        ...
                                                        <input type="text" id="client_name" name="client_name"
                                                            class="form-control" placeholder="{!! __('reservations.client_name') !!}">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-premium">
                                                        ...
                                                        <input type="text" id="client_mobile" name="client_mobile"
                                                            class="form-control" placeholder="{!! __('reservations.client_mobile') !!}">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-premium">
                                                        ...
                                                        <input type="email" id="client_email" name="client_email"
                                                            class="form-control" placeholder="{!! __('reservations.client_email') !!}">
                                                    </div>
                                                    ...
                                                    <div class="input-group input-group-premium">
                                                        ...
                                                        <select class="form-select form-control select2-modal"
                                                            ...
                                                            @foreach ($flights as $flight)
                                                                <option value="{{ $flight->id }}">{{ $flight->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="input-group input-group-premium">
                                                        ...
                                                        <select class="form-select form-control select2-modal"
                                                            ...
                                                            @foreach ($tickets as $ticket)
                                                                <option value="{{ $ticket->id }}">{{ $ticket->title }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="notes" name="notes" class="form-control" rows="5"
                                                        placeholder="{!! __('reservations.notes') !!}..."></textarea>
                        ...
                        <x-dashboard.command-hud formId="create_reservation_form" hudId="create_reservation_hud"
                            countId="create_reservation_count" discardId="create_reservation_discard"
                            submitId="create_reservation_save" />
                    </form>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            // Initialize HUD
            initHud('create_reservation_form', {
                hudId: 'create_reservation_hud',
                countId: 'create_reservation_count',
                discardId: 'create_reservation_discard',
                submitId: 'create_reservation_save',
                isCreate: true
            });
            ...
            function resetForm() {
                $('#create_reservation_form')[0].reset();
                window.clearFormErrors('#create_reservation_form');
                $('.select2-modal').val(null).trigger('change.select2');
            }

            $('#create_reservation_discard').on('click', function() {
                resetForm();
            });

            window.handleFormSubmit('#create_reservation_form', {
                url: "{{ route('dashboard.reservations.store') }}",
                successMessage: "{!! __('general.creation_success_message') !!}",
                onSuccess: function() {
                    setTimeout(function() {
