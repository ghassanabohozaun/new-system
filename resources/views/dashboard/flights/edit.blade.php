                    ...
                    <div class="d-md-flex align-items-center justify-content-between border-bottom mb-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">{!! __('flights.update_flight') !!}</li>
                            </ol>
                        </nav>
                    </div>
                    <!--------------------  End Breadcrumb  ---------------------------->
                        ...
                        <div class="col-md-12">
                            <div class="card card-rounded card-settings-premium">
                                <div class="card-body">
                                    ...
                                    @livewire('dashboard.flight.edit-flight', compact('flight', 'FlightID', 'countries', 'cities', 'categories'))
