    ...
    <div class="query-bar js-query-bar">
        ...
        <form class="js-filter-form d-flex align-items-center gap-2">
                ...
                <div class="filter-popover" id="search_popover">
                    <div class="mb-3 theme-primary">
                        ...
                        <div class="input-group-premium">
                            <span class="input-group-text"><i class="mdi mdi-format-title text-primary"></i></span>
                            <input type="text" class="form-control" name="search_term"
                                placeholder="{!! __('sliders.search_placeholder') !!}">
                        </div>
                    </div>
            ...
            <div class="filter-chip js-filter-chip" data-target="status_popover">
                ...
                <span class="chip-text">{!! __('sliders.status') !!}</span>
                <div class="filter-popover" id="status_popover">
                    <div class="mb-3 theme-warning">
                        <label class="form-label d-block fw-bold mb-1">{!! __('sliders.status') !!}</label>
                        <div class="input-group-premium">
                            <span class="input-group-text"><i
                                    class="mdi mdi-check-circle-outline text-warning"></i></span>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.js-reset-btn').on('click', function() {
                $('.js-filter-chip').removeClass('active');
                $('.filter-popover').fadeOut(100);
                $('.js-filter-form')[0].reset();
                $('.js-filter-form select').val(null).trigger('change');
                setTimeout(() => {
                    $('.js-filter-btn').trigger('click');
                }, 100);
            });
