...
function initTicketsLoadMoreSafe() {
    ...
    btnTickets.onclick = function (e) {
        ...
        if (
            ticketsGrid.querySelectorAll(".ticket-card-item.d-none").length ===
            0
        ) {
            if (btnContainer) {
...
async function fetchLiveRates() {
    try {
        ...
        console.warn(
            "Failed to connect to API, backup rates will be used.",
            error,
        );
...
/**
 * MOCK DATA: Simulated destination data for real-time search
 */
const mockDestinations = [
    {
        title: "Movenpick Resort - Riyadh",
        price: "15,300 SAR",
        img: "https://images.unsplash.com/photo-1547448415-e9f5b28e570d?w=100",
    },
    {
        title: "Le Meridien - Al-Ula",
        price: "12,500 SAR",
        img: "https://images.unsplash.com/photo-1584132967334-10e028bd69f7?w=100",
    },
    {
        title: "Conrad Island - Maldives",
        price: "22,000 SAR",
        img: "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=100",
    },
];

/**
 * TOGGLE MODAL: Opens/Closes the search vault
 */
...
/**
 * SEARCH HANDLER: Filters data and updates the UI instantly
 */
function handleSearch(query) {
    ...
    if (query.trim().length > 0) {
        ...
        // Filter destinations based on query (can be replaced by Laravel API later)
        ...
        resultsList.innerHTML = filtered
            ...
            <div class="result-item">
                ...
                <div class="result-info">
                    ...
                    <span style="color:var(--brand-gold); font-size:0.85rem;">${item.price}</span>
                </div>
            </div>
        `,
            )
        ...
        // Show trending tags if input is empty
...
/**
 * HELPER: Fills search input from trending tags
 */
...
/**
 * EVENT LISTENER: Closes modal on ESC key press
 */
